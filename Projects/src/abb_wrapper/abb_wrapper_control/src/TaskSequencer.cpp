...
void TaskSequencer::diceCallback(const geometry_msgs::Pose::ConstPtr& msg)
{
  ROS_INFO("ciao");
}
...
bool TaskSequencer::call_template_task(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res){
    ...
    //Dice pose 
    ros::Subscriber sub_pose = this->nh.subscribe("dice_pose", 1000, &TaskSequencer::diceCallback,this);
